...
class FileHandler:
    ...
    def process_file(self):
        ...
        try:
            ...
            handlers = {
                ...
                "text/x-python": self._process_txt,
    ...
    def categorize_mime(mime_type):
        ...
        categories = {
            ...
            "code": ["application/octet-stream", "application/json","text/x-python"],
            "tabular": ["text/csv", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"],
            "document": [
                "text/plain", 
                "application/pdf",
